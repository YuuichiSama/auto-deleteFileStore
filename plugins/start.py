...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton(text="⚡️ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 1⚡️", url=client.invitelink2),
            InlineKeyboardButton(text="⚡️ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 2⚡️", url=client.invitelink3),
        ],
        [
            InlineKeyboardButton(text="⚡️ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 3⚡️", url=client.invitelink),
        ]
    ]
    try:
        buttons.append(
